...
public static class ItemColors
{
	...
	public static Color Deployable { get; private set; } = (Color)"#c896ad";
	public static Color Component { get; private set; } = (Color)"#97f5ab";
	public static Color Tool { get; private set; } = (Color)"#8bb0ad";
}
