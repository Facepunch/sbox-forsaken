...
public partial class NPC : AnimatedEntity
{
	...
	/// <summary>
	/// How long the NPC stays idle for before wandering again.
	/// </summary>
	[Property] public float IdleDuration { get; set; } = 30f;
	...
	protected virtual void ServerTick()
	{
		...
		{
			NextWanderTime = IdleDuration;

			var targetPosition = NavMesh.GetPointWithinRadius( Position, 100f, 2000f );
